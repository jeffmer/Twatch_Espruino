...
function startdraw(c){void 0===c&&(c=!1);c||g.clear();c||(intervalRef=setInterval(next,65))}function regen(){stopdraw();g.setColor(1,1,1);initDraw(genA);currentY=1;gentime=generation=0;intervalRef=setInterval(next,65)}function setButtons(){FT5206.on("touch",regen)}TWATCH.on("sleep",function(c){c?stopdraw():startdraw()});
